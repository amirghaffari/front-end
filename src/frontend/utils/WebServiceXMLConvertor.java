 ...
 * @since 3.0
 */
public class WebServiceXMLConvertor extends AbstractMarshaller implements InitializingBean {
	...
	protected final void marshalOutputStream(Object graph, OutputStream outputStream)
		...
		marshalWriter(graph, new OutputStreamWriter(outputStream, encoding));
                //amir
                Convertor.marshaller(graph,outputStream);
                //End amir
	}
	...
	protected final Object unmarshalInputStream(InputStream inputStream) throws XmlMappingException, IOException {
        //amir
                try {
                    Object obj=null;
                    try {
                        obj = frontend.utils.Convertor.unmarshal(inputStream);
                    } catch (AtomLinkException ex) {
                        System.out.println("Error in unmarshalling XML "+ex.getMessage());
